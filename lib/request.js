...
* @param {String} documentTableName The document table name.
* @param {Object} req Request
* @param {Object} res Result
* @api public
*/
function processRequest(serverConfig, oracleSession, username, password, documentTableName, req, res)
{
	'use strict';
	...
	oracle.invoke(oracleSession, username, password, req.params.name, args, cgi, files, documentTableName, function pageReceived(err, page) {
