...
BEGIN
	...
	htp.p('<ul>');
	htp.p('<li><a href="demo.pageSimple?text=some-text">Simple page</a></li>');
	htp.p('<li><a href="!demo.pageFlexible?p1=v1'||CHR(38)||'p2=v2'||CHR(38)||'p3=v3">Flexible parameter passing</a></li>');
	htp.p('<li><a href="demo.pageCGI">CGI</a></li>');
	htp.p('<li><a href="demo.pageCookie">Cookies</a></li>');
	htp.p('<li><a href="demo.pageRedirect">Redirect</a></li>');
	htp.p('<li><a href="demo.pageLocation">Change location</a></li>');
	htp.p('</ul>');
	closePage();
END pageIndex;
...
BEGIN
	owa_util.mime_header('text/html', FALSE);
	owa_cookie.send('fromPage', 'demo.pageRedirect');
	owa_util.redirect_url(curl=>'demo.pageOther', bclose_header=>FALSE);
	owa_util.http_header_close;
END pageRedirect;
...
BEGIN
	...
	htp.p('<script>self.top.location.replace("demo.pageOther");</script>');
	closePage();
END pageLocation;
...
BEGIN
	...
	htp.p('<p><a href="demo.pageIndex">Menu</a></p>');
END openPage;
